...
## DVIA-v2 Jailbreak Detection Test1 Using LLDB

> 앞에서 푼 DVIA-v2 Jailbreak Detection Test1 을 LLDB 동적 디버깅 도구를 사용해서 우회하는 방법을 정리함

출처 : https://hackcatml.tistory.com/47
...
`c` 명령어로 모든 process 를 resume 시키게 되면 "Device is Not Jailbroken" 알람창이 뜨는 것을 확인 가능
