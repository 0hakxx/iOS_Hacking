...
5. 진입한 가상 환경에 Frida Client 설치
```bash
pip install frida==16.1.4 frida-tools
```
- 참고로 `pip install frida==16.1.4` 와 같이 버전 설정 없이 `pip install frida-tools`만 할 경우 최신 버전으로 설치됨
- 또한 최신 버전이 아닌 16.1.4 버전으로 설치한 이유는 많은 후킹 코드, 가이드 등이 해당 버전 위주로 사용하여 편리함을 위해 설정함


6. Frida 정상 설치 확인 : `frida --version`  설치 확인 : `frida --version` 
...
6. 백그라운드로 Frida 서버 실행 : `frida-server &`
...
1. <img src="Jailbreak_Detection2.png" width="300px">
...
3. ![img_17.png](Jailbreak_Detection3.png)
...
![img_20.png](Jailbreak_Detection6.png)
...
![img_23.png](Jailbreak_Detection9.png)
...
- 그래서 : `0x100171f5c - 0x100000000 = 0x171f5c` , 이 `0x171f5c` 가 Frida에서 사용할 진짜 오프셋이다.
  - ![img.png](Jailbreak_Detection18.png)  
...
4. ![img_25.png](Jailbreak_Detection11.png)
...
5. ![img_26.png](Jailbreak_Detection12.png)
...
4. ![img_27.png](Jailbreak_Detection13.png)
...
<img src="Jailbreak_Detection2.png" width="300px">
...
4. ![img_28.png](Jailbreak_Detection14.png)
...
4. ![img_29.png](Jailbreak_Detection15.png)
...
4. ![img_30.png](Jailbreak_Detection16.png)
...
4. ![img_31.png](Jailbreak_Detection17.png)
