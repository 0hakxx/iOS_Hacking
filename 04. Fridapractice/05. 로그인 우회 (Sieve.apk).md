...
- ![img_22.png](Sieve1.png)

잘못된 비밀번호 입력 시 화면

로직 파악을 위해 문자열 검사 진행

- ![img_23.png](Sieve2.png)
...
- ![img_24.png](Sieve3.png)

패키지 메인 클래스에서

관련 메서드를 유추

- ![img_25.png](Sieve4.png)

의심 가는 메서드가 어디서 호출되는지 확인

- ![img_26.png](Sieve5.png)
...
- ![img_29.png](Sieve8.png)

- ![img_30.png](Sieve9.png)
