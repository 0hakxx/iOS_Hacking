...
> 3uTools 도구로 내부 폴더 접근 안 될 시 WinSCP 로 대체 사용
...
1. Choicy
- 사용법: 설정 -> Choicy -> Applications -> 대상 앱 선택 -> Disable Tweak Injection 활성화

2. Shadow
- Bypass Settings에서 'File System', 'Library', 'OpenURL' 등을 개별적으로 숨길 수 있음
